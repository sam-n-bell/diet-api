from dietapi.users.models import User, UserJwt
from dietapi import db, bcrypt
from dietapi.users.utils import serialize_one
...
def generate_jwt(user):
    return create_access_token(serialize_one(user), expires_delta=timedelta(days=1))
